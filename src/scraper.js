...
/**
 * Scrapes Spine model files from a GameKee URL.
 *
 * Yields progress events: { step: string, message: string, error?: string }
 * Steps: browser, page, skins, download, done, error
 *
 * @param {string} url - GameKee page URL.
 * @param {string} baseName - Character name prefix for output folders.
